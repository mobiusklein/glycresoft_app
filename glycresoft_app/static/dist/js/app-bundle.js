  ...
  ModificationSelectionEditor.prototype.createModification = function() {
    ...
    return $.post("/glycopeptide_search_space/modification_menu", formData).done((function(_this) {
      return function(payload) {
        var _, k, l, len, len1, modRule, modSpec, ref, ref1, ref2, spec, specParsed;
        ...
        for (k = 0, len = ref.length; k < len; k++) {
          spec = ref[k];
          console.log(spec);
          ref1 = parseModificationRuleSpecification(spec), _ = ref1[0], specParsed = ref1[1];
          modRule.addTarget(specParsed);
        }
        console.log("New modification rule", modRule);
        ref2 = modRule.toSpecifications();
