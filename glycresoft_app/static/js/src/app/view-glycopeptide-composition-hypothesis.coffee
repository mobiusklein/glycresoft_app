viewGlycopeptideCompositionHypothesis = (hypothesisId) ->
    ...
    setupGlycopeptideCompositionTablePageHandler = (page=1) ->        
    ...
    updateCompositionTablePage = (page=1) ->
        ...
        GlycReSoft.ajaxWithContext(url).success (doc) ->
            ...
            setupGlycopeptideCompositionTablePageHandler page
